...
int main() {
    ...
    float yStretchFactor = 1.0f;
    float contrastFactor = 1.09f;
    float sharpenStrength = 1.09f;
    float gammaValue = 0.6f;

    processAndMergeImageParts("ezwan-lorry-4800-1.txt", linesToProcess, darkPixelThreshold, darkThreshold, yStretchFactor, contrastFactor, sharpenStrength, gammaValue);
    return 0;
}
