/****************************************************************************
** Meta object code from reading C++ file 'image_label.h'
**
...
#error "The header file 'image_label.h' doesn't include <QObject>."
...
void ImageLabel::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->mouseMoved((*reinterpret_cast< std::add_pointer_t<QPoint>>(_a[1]))); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (ImageLabel::*)(const QPoint & );
            if (_t _q_method = &ImageLabel::mouseMoved; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void ImageLabel::mouseMoved(const QPoint & _t1)
{
